namespace Core
{
    ...
    public class Vocabulary
    {
        ...
        protected const string _doesnt = _does + _n + "'" + _t;
        protected const string _Dont = _D + _on + "'" + _t;
        protected const string _dont = _d + _on + "'" + _t;
        ...
        protected const string _inmemory = _in + "-" + _memory;
        ...
        protected const string _Non_ = _No + _n + "-";
