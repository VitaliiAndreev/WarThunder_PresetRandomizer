...
{
    public class EVectorImageKey
    {
        public class Flag
        {
            private const string _prefix = "country_";
            private const string _suffix = "DrawingImage";
            ...
            public const string NorthKorea = _prefix + "north_korea" + _suffix;
            public const string Norway = _prefix + "norway" + _suffix;
