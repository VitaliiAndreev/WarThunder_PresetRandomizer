...
namespace Client.Wpf.Controls.Base
{
    ...
    public abstract class ColumnToggleControlWithResources<T, U>: ToggleButtonGroupControlWithResource<U>
    {
        #region Fields
        ...
        public ColumnToggleControlWithResources(T owner)
            : this()
        {
            Owner = owner;
        }
        ...
        /// <summary> Creates a new control. </summary>
        public ColumnToggleControlWithResources()
        {
