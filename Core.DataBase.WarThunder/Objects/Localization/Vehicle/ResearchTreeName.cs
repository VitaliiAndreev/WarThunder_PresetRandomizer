...
{
    [Class(Table = ETable.LocalizationVehicleResearchTreeName)]
    public class ResearchTreeName : VehicleLocalization
    {
        ...
        [ManyToOne(0, Column = ETable.Vehicle + "_" + EColumn.Id, ClassType = typeof(Objects.Vehicle), NotNull = true)]
        ...
        public ResearchTreeName(IDataRepository dataRepository, IVehicle vehicle, IList<string> localizationRecord)
