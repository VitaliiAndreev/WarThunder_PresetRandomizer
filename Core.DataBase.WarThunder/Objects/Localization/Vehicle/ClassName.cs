...
{
    [Class(Table = ETable.LocalizationVehicleClassName)]
    public class ClassName : VehicleLocalization
    {
        ...
        public ClassName(IDataRepository dataRepository, IVehicle vehicle, IList<string> localizationRecord)
