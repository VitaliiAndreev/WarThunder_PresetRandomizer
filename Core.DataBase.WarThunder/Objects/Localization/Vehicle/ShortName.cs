...
{
    [Class(Table = ETable.LocalizationVehicleShortName)]
    public class ShortName : VehicleLocalization
    {
        ...
        public ShortName(IDataRepository dataRepository, IVehicle vehicle, IList<string> localizationRecord)
