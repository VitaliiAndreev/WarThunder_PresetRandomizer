...
namespace Core.DataBase.WarThunder.Objects.VehicleGameModeParameterSet.Integer
{
    ...
    public class RepairCost: VehicleGameModeParameterSetBase, IVehicleGameModeParameterSet<int?>
    {
        ...
        public RepairCost(IDataRepository dataRepository, IVehicleEconomyData economyData)
        ...
        /// <param name="economyData"> The entity the set belongs to. </param>
        public RepairCost(IDataRepository dataRepository, long id, IVehicleEconomyData economyData)
        ...
        public RepairCost(IDataRepository dataRepository, IVehicleEconomyData economyData, int? valueInArcade, int? valueInRealistic, int? valueInSimulator, int? valueInEvent)
        ...
        /// <param name="valueInSimulator"> The value in Simulator Battles. </param>
        /// <param name="valueInEvent"> The value in Event Battles. </param>
        public RepairCost(IDataRepository dataRepository, long id, IVehicleEconomyData economyData, int? valueInArcade, int? valueInRealistic, int? valueInSimulator, int? valueInEvent)
