...
namespace Core.DataBase.WarThunder.Objects.VehicleGameModeParameterSet.Integer
{
    ...
    [Class(Table = ETable.VehicleEconomicRank)]
    public class EconomicRank: VehicleGameModeParameterSetBase, IVehicleGameModeParameterSet<int?>
    {
        #region Fields
        ...
        public EconomicRank(IDataRepository dataRepository, IVehicle vehicle)
        ...
        /// <param name="vehicle"> The set's vehicle. </param>
        public EconomicRank(IDataRepository dataRepository, long id, IVehicle vehicle)
        ...
        public EconomicRank(IDataRepository dataRepository, IVehicle vehicle, int? valueInArcade, int? valueInRealistic, int? valueInSimulator, int? valueInEvent)
