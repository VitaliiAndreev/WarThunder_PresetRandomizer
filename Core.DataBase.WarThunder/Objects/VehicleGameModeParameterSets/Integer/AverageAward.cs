...
namespace Core.DataBase.WarThunder.Objects.VehicleGameModeParameterSet.Integer
{
    ...
    [Class(Table = ETable.VehicleAverageAward)]
    public class AverageAward: VehicleGameModeParameterSetBase, IVehicleGameModeParameterSet<int?>
    {
        #region Fields
        ...
        public AverageAward(IDataRepository dataRepository, IVehicle vehicle)
        ...
        /// <param name="vehicle"> The set's vehicle. </param>
        public AverageAward(IDataRepository dataRepository, long id, IVehicle vehicle)
        ...
        public AverageAward(IDataRepository dataRepository, IVehicle vehicle, int? valueInArcade, int? valueInRealistic, int? valueInSimulator, int? valueInEvent)
        ...
        /// <param name="id"> The set's ID. </param>
        /// <param name="vehicle"> The set's vehicle. </param>
        public AverageAward(IDataRepository dataRepository, long id, IVehicle vehicle, int? valueInArcade, int? valueInRealistic, int? valueInSimulator, int? valueInEvent)
