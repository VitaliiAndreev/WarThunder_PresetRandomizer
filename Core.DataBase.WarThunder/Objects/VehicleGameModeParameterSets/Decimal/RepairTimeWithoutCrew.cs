...
namespace Core.DataBase.WarThunder.Objects.VehicleGameModeParameterSet.Decimal
{
    ...
    [Class(Table = ETable.VehicleRepairTimeWithoutCrew)]
    public class RepairTimeWithoutCrew: VehicleGameModeParameterSetBase, IVehicleGameModeParameterSet<decimal?>
    {
        #region Fields
        ...
        protected RepairTimeWithoutCrew()
        {
        }
        ...
        public RepairTimeWithoutCrew(IDataRepository dataRepository, IVehicleEconomyData economyData)
        ...
        /// <param name="economyData"> The entity the set belongs to. </param>
        public RepairTimeWithoutCrew(IDataRepository dataRepository, long id, IVehicleEconomyData economyData)
        ...
        public RepairTimeWithoutCrew(IDataRepository dataRepository, IVehicleEconomyData economyData, decimal? valueInArcade, decimal? valueInRealistic, decimal? valueInSimulator, decimal? valueInEvent)
        ...
        /// <param name="valueInSimulator"> The value in Simulator Battles. </param>
        /// <param name="valueInEvent"> The value in Event Battles. </param>
        public RepairTimeWithoutCrew(IDataRepository dataRepository, long id, IVehicleEconomyData economyData, decimal? valueInArcade, decimal? valueInRealistic, decimal? valueInSimulator, decimal? valueInEvent)
