...
namespace Core.DataBase.WarThunder.Objects.VehicleGameModeParameterSet.Decimal
{
    ...
    public class RewardMultiplier: VehicleGameModeParameterSetBase, IVehicleGameModeParameterSet<decimal?>
    {
        ...
        public RewardMultiplier(IDataRepository dataRepository, IVehicle vehicle)
        ...
        /// <param name="vehicle"> The set's vehicle. </param>
        public RewardMultiplier(IDataRepository dataRepository, long id, IVehicle vehicle)
        ...
        public RewardMultiplier(IDataRepository dataRepository, IVehicle vehicle, decimal? valueInArcade, decimal? valueInRealistic, decimal? valueInSimulator, decimal? valueInEvent)
        ...
        /// <param name="id"> The set's ID. </param>
        /// <param name="vehicle"> The set's vehicle. </param>
        public RewardMultiplier(IDataRepository dataRepository, long id, IVehicle vehicle, decimal? valueInArcade, decimal? valueInRealistic, decimal? valueInSimulator, decimal? valueInEvent)
