...
namespace Core.DataBase.WarThunder.Objects.VehicleGameModeParameterSet.Decimal
{
    ...
    public class VisualRewardMultiplier: VehicleGameModeParameterSetBase, IVehicleGameModeParameterSet<decimal?>
    {
        ...
        public VisualRewardMultiplier(IDataRepository dataRepository, IVehicleEconomyData economyData)
        ...
        /// <param name="economyData"> The entity the set belongs to. </param>
        public VisualRewardMultiplier(IDataRepository dataRepository, long id, IVehicleEconomyData economyData)
        ...
        public VisualRewardMultiplier(IDataRepository dataRepository, IVehicleEconomyData economyData, decimal? valueInArcade, decimal? valueInRealistic, decimal? valueInSimulator, decimal? valueInEvent)
        ...
        /// <param name="valueInSimulator"> The value in Simulator Battles. </param>
        /// <param name="valueInEvent"> The value in Event Battles. </param>
        public VisualRewardMultiplier(IDataRepository dataRepository, long id, IVehicleEconomyData economyData, decimal? valueInArcade, decimal? valueInRealistic, decimal? valueInSimulator, decimal? valueInEvent)
