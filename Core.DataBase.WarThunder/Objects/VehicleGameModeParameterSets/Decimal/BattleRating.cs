...
namespace Core.DataBase.WarThunder.Objects.VehicleGameModeParameterSet.Decimal
{
    ...
    public class BattleRating: VehicleGameModeParameterSetBase, IVehicleGameModeParameterSet<decimal?>
    {
        #region Fields
        ...
        public BattleRating(IDataRepository dataRepository, IVehicle vehicle, decimal? valueInArcade, decimal? valueInRealistic, decimal? valueInSimulator, decimal? valueInEvent)
