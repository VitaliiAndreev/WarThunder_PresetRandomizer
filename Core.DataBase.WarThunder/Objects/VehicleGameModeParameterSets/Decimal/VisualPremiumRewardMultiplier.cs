...
namespace Core.DataBase.WarThunder.Objects.VehicleGameModeParameterSet.Decimal
{
    ...
    public class VisualPremiumRewardMultiplier: VehicleGameModeParameterSetBase, IVehicleGameModeParameterSet<decimal?>
    {
        ...
        public VisualPremiumRewardMultiplier(IDataRepository dataRepository, IVehicle vehicle)
        ...
        /// <param name="vehicle"> The set's vehicle. </param>
        public VisualPremiumRewardMultiplier(IDataRepository dataRepository, long id, IVehicle vehicle)
        ...
        public VisualPremiumRewardMultiplier(IDataRepository dataRepository, IVehicle vehicle, decimal? valueInArcade, decimal? valueInRealistic, decimal? valueInSimulator, decimal? valueInEvent)
        ...
        /// <param name="id"> The set's ID. </param>
        /// <param name="vehicle"> The set's vehicle. </param>
        public VisualPremiumRewardMultiplier(IDataRepository dataRepository, long id, IVehicle vehicle, decimal? valueInArcade, decimal? valueInRealistic, decimal? valueInSimulator, decimal? valueInEvent)
