...
namespace Core.DataBase.WarThunder.Objects.VehicleGameModeParameterSet.Decimal
{
    ...
    [Class(Table = ETable.VehicleVisualPremiumRewardMultiplier)]
    public class VisualPremiumRewardMultiplier: VehicleGameModeParameterSetBase, IVehicleGameModeParameterSet<decimal?>
    {
        #region Fields
        ...
        protected VisualPremiumRewardMultiplier()
        {
        }
        ...
        public VisualPremiumRewardMultiplier(IDataRepository dataRepository, IVehicleEconomyData economyData)
        ...
        /// <param name="economyData"> The entity the set belongs to. </param>
        public VisualPremiumRewardMultiplier(IDataRepository dataRepository, long id, IVehicleEconomyData economyData)
        ...
        public VisualPremiumRewardMultiplier(IDataRepository dataRepository, IVehicleEconomyData economyData, decimal? valueInArcade, decimal? valueInRealistic, decimal? valueInSimulator, decimal? valueInEvent)
        ...
        /// <param name="id"> The set's ID. </param>
        /// <param name="economyData"> The entity the set belongs to. </param>
        public VisualPremiumRewardMultiplier(IDataRepository dataRepository, long id, IVehicleEconomyData economyData, decimal? valueInArcade, decimal? valueInRealistic, decimal? valueInSimulator, decimal? valueInEvent)
