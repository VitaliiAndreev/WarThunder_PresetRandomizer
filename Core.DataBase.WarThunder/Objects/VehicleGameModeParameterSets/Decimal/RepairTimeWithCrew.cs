...
namespace Core.DataBase.WarThunder.Objects.VehicleGameModeParameterSet.Decimal
{
    ...
    public class RepairTimeWithCrew: VehicleGameModeParameterSetBase, IVehicleGameModeParameterSet<decimal?>
    {
        ...
        public RepairTimeWithCrew(IDataRepository dataRepository, IVehicleEconomyData economyData)
        ...
        /// <param name="economyData"> The entity the set belongs to. </param>
        public RepairTimeWithCrew(IDataRepository dataRepository, long id, IVehicleEconomyData economyData)
        ...
        public RepairTimeWithCrew(IDataRepository dataRepository, IVehicleEconomyData economyData, decimal? valueInArcade, decimal? valueInRealistic, decimal? valueInSimulator, decimal? valueInEvent)
        ...
        /// <param name="id"> The set's ID. </param>
        /// <param name="economyData"> The entity the set belongs to. </param>
        public RepairTimeWithCrew(IDataRepository dataRepository, long id, IVehicleEconomyData economyData, decimal? valueInArcade, decimal? valueInRealistic, decimal? valueInSimulator, decimal? valueInEvent)
