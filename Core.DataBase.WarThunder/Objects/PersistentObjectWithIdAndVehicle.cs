...
{
    public abstract class PersistentObjectWithIdAndVehicle : PersistentObjectWithId, IPersistentObjectWithIdAndVehicle
    {
        #region Properties
        ...
        protected PersistentObjectWithIdAndVehicle()
        {
        }
        ...
        public PersistentObjectWithIdAndVehicle(IDataRepository dataRepository, long id, IVehicle vehicle)
